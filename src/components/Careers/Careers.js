      ...
      <div className="title_career">
        <h1>
         <span> Welcome to Blitzpath Innovations </span>,<br />
          At Blitzpath, we value individuals
          who are eager to learn and grow, and we provide them with the
          opportunity to advance their careers. Join us in our mission to
          revolutionize the IT services industry.
        </h1>
      </div>
            ...
            return (
              <div className="job" key={index}>
                ...
                <Job
                  ...
                  requirement={ele.responsibilities}
                />
